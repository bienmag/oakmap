...
export function TreeEditorMode({
  ...
  marked,
  setMarked,
<<<<<<< HEAD:apps/web/pages/Components/Modes/TreeEditorMode.tsx
}: any) {
...
>>>>>>> a3e1004 (refactor: fix typescript types on all files):apps/web/Components/Modes/TreeEditorMode.tsx
