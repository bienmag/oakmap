...
function ModeSelector({ treeMode, setTreeMode, marked, setMarked }: any ){
  ...
  return(
    <div>
      {dashboard ? <DashboardMode /> : <TreeEditorMode treeMode={treeMode} setTreeMode={setTreeMode} marked={marked} setMarked={setMarked}  />}
    </div>
